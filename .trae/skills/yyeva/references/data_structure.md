...
[
  {
    ...
    data: [           // 该帧所有动态元素的位置数据
      {
        effectId: 0,  // 对应 effect 中的 key
        renderFrame: [50, 100, 200, 50],   // 渲染区域（相对于原始设计）
        outputFrame: [50, 100, 200, 50]    // 输出区域（相对于最终画面）
      },
      {
        effectId: 1,
        renderFrame: [260, 50, 100, 100],
        outputFrame: [260, 50, 100, 100]
      }
    ]
  },
  {
...
- `renderFrame`: [x, y, w, h] 渲染区域
- `outputFrame`: [x, y, w, h] 输出区域（实际绘制位置）
